          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full px-4 py-3 pr-11 rounded-xl bg-zinc-900 border-2 border-zinc-700 text-white placeholder-zinc-600 outline-none focus:border-brand-orange transition-colors"
              />
              <button
                type="button"
